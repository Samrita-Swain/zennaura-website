...
// function renderModalContent(view: MODAL_VIEW | string | null) {
//   switch (view) {
//     case 'SIGN_IN':
//       return <SignIn className="!m-0 !p-0" />;
//     case 'SIGN_UP':
...
//   useEffect(() => {
//     closeModal();
//     // Intentionally left blank to avoid dependency issues
//     // eslint-disable-next-line react-hooks/exhaustive-deps
//   }, [pathName]);
...
//           leaveTo="opacity-0"
//         >
//           <div className="fixed inset-0 z-[9999] bg-black bg-opacity-40 cursor-pointer" onClick={closeModal}></div>
//         </Transition.Child>
...
//         {/* Hidden button to fix FocusTap headless-ui warning */}
//         <div className="sr-only">
//           <Button
//             size="sm"
//             onClick={closeModal}
  ...
  return (
    <Transition appear show={open} as={Fragment}>
      <Dialog
        ...
        className={clsx(
          'fixed inset-0 z-[9999] h-full w-full overflow-y-auto overflow-x-hidden bg-gray-dark bg-opacity-40 p-4 text-center',
          // Using type assertion here to handle the check more flexibly
          (view as string) === 'LIGHT_GALLERY' && '!bg-opacity-100'
        )}
        onClose={closeModal}
      >
        <Transition.Child
