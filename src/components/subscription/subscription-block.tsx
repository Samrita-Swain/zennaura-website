...
export default function SubscriptionBlock({
  ...
  return (
    <BannerBlock
      bgImg="/images/zennaura-last-bg.jpg"
      ...
      titleClassName="!text-primary md:!text-[#000] text-2xl 3xl:text-[44px] 3xl:leading-[64px] mb-2 xl:mb-5"
      descriptionClassName="text-sm md:text-base !text-primary md:!text-[#000] text-center md:text-left leading-[22px] md:leading-6 3xl:leading-8 mb-6 md:!mb-8"
